...
exports.DailyRotateFileTransport = void 0;
const fs = require("fs");
const os = require("os");
...
class DailyRotateFileTransport extends Transport {
    constructor(options = {}) {
        ...
        if (options.stream) {
            ...
            this.logStream = new stream_1.PassThrough();
            ...
            const rotator = new fileStreamRotator_1.FileStreamRotator();
            this.logStream = rotator.getStream({
                ...
                audit_file: options.auditFile
                    ? options.auditFile
                    : path.join(options.auditFileDir || this.dirname, '.' + hash(options) + '-audit.json'),
    ...
    log(info, callback) {
        ...
        this.logStream.write(info[triple_beam_1.MESSAGE] + this.options.eol);
...
exports.DailyRotateFileTransport = DailyRotateFileTransport;
