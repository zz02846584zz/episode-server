...
exports.FileStreamRotator = void 0;
const fs = require("fs");
    ...
    try {
        ...
        if (err && err.code === 'ENOENT') {
            try {
                ...
                debug(new Date().toLocaleString(), '[FileStreamRotator] Could not create symlink file: ', current, ' -> ', logfileName);
            }
        }
    }
}
...
class FileStreamRotator {
    ...
    getStream(options) {
        ...
        const auditLog = this.setAuditLog(options.max_logs, options.audit_file, options.filename);
        if (auditLog != null) {
            auditLog.hashType =
